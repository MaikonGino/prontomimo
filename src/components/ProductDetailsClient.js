...
import DOMPurify from 'dompurify'; // THIS IS THE CORRECTED IMPORT
...
export default function ProductDetailsClient({ product }) {
    ...
    // This check ensures DOMPurify only runs in the browser, which is a best practice.
        ...
        <div className="details-main">
            ...
            <div className="details-container">
                ...
                <div className="info">
                    ...
                    <div>
                        {isOutOfStock && <p className="stock-display low">Esgotado</p>}
                        {product.stock > 0 && product.stock <= 5 && <p className="stock-display low">Restam apenas {product.stock} unidades!</p>}
                        {product.stock > 5 && <p className="stock-display in-stock">Em estoque</p>}
                    </div>
                    ...
                    >
                        {isOutOfStock ? 'Esgotado' : (
                            <>
                                <svg style={{ width: 22, height: 22 }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
